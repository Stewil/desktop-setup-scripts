...
install_wm(){
    ...
    sudo apt install -y i3-wm picom i3-blocks i3status dunst rofi nitrogen arandr xinit scrot
    sudo apt install -y libxcb-render0-dev libffi-dev python-dev python-cffi
